...
lib.ssMetadata = [
		{name:"LOQ_15ARP_GDN_300x250_atlas_1", frames: [[302,756,50,50],[0,0,300,250],[0,252,300,250],[0,504,300,250],[0,756,300,250],[302,0,300,250],[302,252,300,250],[302,504,300,250]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["LOQ_15ARP_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.LOQ15ARPGDN300x250 = function(mode,startPosition,loop,reversed) {
...
// library properties:
lib.properties = {
	id: 'EF1565A52B4D4F4E9C2D7A0A6944535C',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/LOQ_15ARP_GDN_300x250_atlas_1.png", id:"LOQ_15ARP_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['EF1565A52B4D4F4E9C2D7A0A6944535C'] = {
